            ...
            <div class="form">
                <el-form
                    ...
                    <el-form-item label="茶叶类型:" >
                        <el-select v-model="form.type" placeholder="茶叶类型">
                            <el-option
                    ...
                    <el-form-item prop='describe' label="茶叶描述:">
                    ...
                    <el-form-item prop='cash' label="茶叶原价:">
    ...
    export default {
        ...
        data() {
            return {
                ...
                form_rules: {
                    describe: [
                        { required: true, message: "茶叶描述不能为空！", trigger: "blur" }
                    ],
                    income: [
                    ...
                    cash: [{ required: true, message: "茶叶原价不能为空！", trigger: "blur" }]
                }
            };
        },
        methods: {
